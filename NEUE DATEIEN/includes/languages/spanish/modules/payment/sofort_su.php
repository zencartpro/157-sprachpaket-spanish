...
define('MODULE_PAYMENT_SOFORT_SU_TEXT_ERROR_MESSAGE', 'Lamentablemente, el método de pago seleccionado no es posible o ha sido cancelado a petición del cliente. Seleccione otra forma de pago.');